...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ownerviewstyle.css">
</head>
<body>
...
<div class="col-md-10">
    <div class="col-md-3">
        ...
        <div class="circle"></div>
            ...
            <h4 class="font" style="text-align:center;"><strong><a href="ownerview.php" style="color:white;">ViewAllStudents</a></strong></h4>
    ...
    <div class="col-md-9">
        <nav class="list1">
            ...
            <button type="submit" class="btn" style="margin-left:35%;margin-top:1%; color:#5ABAE1;"><a href="login.php">SignOut</a></button>
        </nav>
        
        <h3 style="color:white;position:relative;left:5%;"><strong>ALL STUDENTS</strong></h3>
        <div>
            <form class="form-inline" action="ownersort.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Student Id" name="studentname">
                </div>
