...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ownerviewingstyle.css">
...
$result = mysqli_query($connect,$query);
         ...
         <div class="box" style="height:40%;">
          ...
          </div> <?php }mysqli_close($connect);?>
           <table class="table table-striped" style="width:70%;position:relative;left:15%;">
            <thead>
              <tr>
                <th >S.NO</th>
                <th >Date,Time</th>
            ...
            <?php     
                $connect = mysqli_connect('localhost','root','','schoolwebsite');
            $query = "select * from `accountantregiater` where id='$id'";
$result = mysqli_query($connect,$query);$i=0;
