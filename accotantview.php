...
if(isset($_POST['pay']))
{
    ...
    $query="insert into `accountantregiater`(id,amountpaid,date) values('$id','$amountpaid','$date')";
        ...
        <div>
            ...
            <thead>
              <tr>
                ...
                <th style="color:white;"><a href="accountantregister.php" style="text-decoration: none;color:white;">Payment</a></th>
              </tr>
            </thead>
            <tbody>
                 <?php 
        ...
        <tr>
        	...
        	<th><?php echo $paid;?></th>
                <th><?php echo $remain ;?></th>
        	 	<th><a href="accountantregister.php?id=<?php echo $row['id'];?>">PAY</a></th>
